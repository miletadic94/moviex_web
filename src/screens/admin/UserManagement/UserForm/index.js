...
const UserForm = ({ handleSubmit, onSubmit, initialValues, loading }) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="row align-items-center">
        ...
        <div className="col-lg-2 col-md-6">
          <Field name="isConfirmed" component={SwitchField} label="Active" />
        </div>
      </div>
      <div className="mt-3">
        <Button
...
export default reduxForm({ form: "userForm", enableReinitialize: true })(
  UserForm
);
